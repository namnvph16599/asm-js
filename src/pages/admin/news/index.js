...
<div class="flex-1 min-w-0">
  ...
  <span class="ml-3 relative sm:hidden">
    ...
    <div class="origin-top-right absolute right-0 mt-2 -mr-1 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="mobile-menu-button" tabindex="-1">
      <!-- Active: "bg-gray-100", Not Active: "" -->
      <a href="/admin/news/edit" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="mobile-menu-item-0">Edit</a>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                  ...
                  ${data
                    ...
                    <tr>
                      ...
                      <td>
                        <img src="${val.img}" alt="" width="50px">
                      </td>
                      <td>
                      ${val.desc}
                    </td>
                      ...
                      <td>
                      <a href="/admin/news/${val.id}/edit">Edit</a>
                      <button data-id=${
                        val.id
                      } class="btn btn-remove ">Delete</button>
                      </td>
                    </tr>
